        ...
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-60 max-w-full px-4 xl:mr-12">
              ...
              >
                <Image
                  src="/images/logo/deep-wave-logo.png"
                  alt="Deep Wave Leads"
                  width={180}
                  height={40}
            ...
            <div className="flex w-full items-center justify-between px-4">
              ...
              <div className="flex items-center justify-end pr-16 lg:pr-0">
                <Link
                  href="/#contact"
                  className="ease-in-up aqua-glow hidden rounded-md bg-secondary px-8 py-3 text-base font-medium text-white transition duration-300 hover:bg-secondary/90 md:block md:px-9 lg:px-6 xl:px-9"
                >
                  Get Started
                </Link>
                <div>
